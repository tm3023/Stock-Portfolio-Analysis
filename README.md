...
Mathematical methods are used to build a diverse stock portfolio from S&amp;P 500 stocks. Monte Carlo simulations are then used to evaluate the performance in addition to risk measures of the portfolio before and after weighting optimisation. An efficient frontier is used to find weightings that meet desired performance criteria. These methods are beneficial for determining an optimal invetsement strategy and mitigating risk.
